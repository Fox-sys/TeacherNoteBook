"""
Django settings for TeachersNoteBook project.
...
ROOT_URLCONF = 'TeachersNoteBook.urls'
...
WSGI_APPLICATION = 'TeachersNoteBook.wsgi.application'
...
AUTH_USER_MODEL = 'notebook.Teacher'